...
def get_opts():
    ...
    parser.add_argument('--dataset_name', type=str, default='mvcam',
                        choices=['nvidia', 'mvcam'],
    ...
    parser.add_argument('--loss_type', type=str, default='full_loss',
                        choices=['mse', 'l1', 'masked_l1', 'vgg_video', 'fgbgl1', 'fgbgvgg', 'full_loss', 'no_mask', 'vgg_only'],
    ...
    ###########################
    #### params for StereoMag ####
    parser.add_argument('--mpi_model', help="restore checkpoint")
    ###########################
